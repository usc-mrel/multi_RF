function [C,time,g,slew,k, phi, sta, stb,p_of_t,VERSE_out] = minTimeGradient_VERSE(C,g0, gfin, gmax, smax,T, ds, show,VERSE_in)
% 
...
function [sdot, k] = sdotMax(PP, p_of_s, s, gmax, smax,W,bmax)
