...
% Please uncomment line 8 - 24 for a simple test.
% If generating figures, keep them commented. 
...
load(fullfile(root_path, '/multi_RF/third_party/phase_relaxed_CPMG_excitation/b0_b1_maps_2d.mat'));
...
girf = load(fullfile(root_path, '/multi_RF/third_party/reVERSE-GIRF/GIRF_3T_London_20140729.mat'));
...
% save the results
cur_dir = pwd;  
cd(output_path); % this is set up from the script
...
%% generate Suppporting Figure S1
if 0
